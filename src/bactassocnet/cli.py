...
def _build_parser():
    p = argparse.ArgumentParser(prog='bact-assoc-net', description='Run bact-assoc-net pipeline')
...
def main(argv=None):
    ...
    try:
        ...
        outdir = Path(getattr(cfg, 'output_dir', 'network_results'))
