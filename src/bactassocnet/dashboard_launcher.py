"""Launcher for the bact-assoc-net marimo dashboard."""
...
def _dashboard_file() -> str:
    dash = resources.files("bactassocnet.dashboards").joinpath("app.py")
    with resources.as_file(dash) as p:
        return str(p)


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="bact-assoc-net-dashboard")
    ...
    try:
        ...
        print("marimo is not installed. Install: pip install 'bact-assoc-net[gui]'", file=sys.stderr)
        return 2
